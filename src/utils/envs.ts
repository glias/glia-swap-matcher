...
console.log(`SUDT_TYPE_SCRIPT_HASH:${SUDT_TYPE_SCRIPT_HASH}`)
...
console.log(`INFO_TYPE_SCRIPT_HASH:${INFO_TYPE_SCRIPT_HASH}`)
...
console.log(`Secp256k1 args: MATCHER_PUBLIC_KEY_HASH:${MATCHER_ADDRESS}`)
